            ...
            >
              <div className="relative flex  overflow-hidden flex-row items-center bg-white rounded-full pr-[max(4px,0.2083333333vw)]">
                <input
                  ...
                  className="w-full h-[max(44px,3.4895833333vw)] pl-[max(20px,2.0833333333vw)] sm:flex-1 bg-transparent placeholder-foreground text-foreground outline-none text-body-medium-vietnam-sm text-left!"
                  required
                />
                <button
                  type="submit"
