        ...
        <div className="relative bg-primary rounded-[20px] px-6 py-16 sm:px-8 sm:py-20 md:px-16 md:py-24 text-center text-white shadow-2xl shadow-teal-900/10">
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-body-medium-vietnam">
            ...
            >
              <div className="relative flex flex-col sm:flex-row items-center p-1 pr-[5px] bg-white rounded-2xl sm:rounded-full">
                <input
                  ...
                  className="w-full sm:flex-1 px-8 py-3 bg-transparent placeholder-foreground outline-none text-body-medium-vietnam text-left!"
                  required
                />
                <button
                  type="submit"
                  className="w-full sm:w-auto px-10 h-[60px] bg-primary text-white rounded-xl sm:rounded-full uppercase tracking-wider text-body-large-vietnam transition-transform active:scale-95"
                >
                  SUBSCRIBE
                </button>
              </div>
            ...
            <p className="text-body-small-vietnam pt-2 max-w-[624px] mx-auto">
