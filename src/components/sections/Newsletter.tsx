            ...
            >
              <div className="relative flex flex-col overflow-hidden sm:flex-row items-center p-1 pr-[5px] bg-white rounded-2xl sm:rounded-full">
                <input
                  ...
                  className="w-full sm:flex-1 px-8 py-4 bg-transparent placeholder-foreground text-foreground outline-none text-body-medium-vietnam text-left!"
                  required
                />
                <button
                  type="submit"
                  className="w-full sm:w-auto px-10 h-[66px] bg-primary hover:bg-primary-light cursor-pointer text-white rounded-xl sm:rounded-full uppercase tracking-wider text-body-large-vietnam"
                >
                  SUBSCRIBE
                </button>
              </div>
