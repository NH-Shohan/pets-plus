...
function VerifiedBadge() {
  return (
    <div className="absolute top-4 right-4 sm:top-10 sm:-right-4 lg:-right-40 bg-surface rounded-xl px-4 py-3 shadow-lg flex items-center gap-3 pointer-events-none">
      ...
      <div>
        <p className="text-body-large text-foreground font-bold">
          Verified Breeder
        </p>
  ...
  return (
    <section className="w-full bg-mint-subtle! section-padding-top-bottom overflow-hidden">
      <div className="main-container">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-32 items-center">
          {/* Left - Image */}
          ...
          {/* Right - Content */}
          <div className="flex flex-col items-start gap-6 lg:col-span-3 max-w-[max(720px,38vw)] w-full lg:mt-[60px]">
            ...
            <div className="">
              <p className="text-body-medium text-foreground  text-left! margin-bottom-lg">
                Every seller on our platform is carefully screened to help
                ensure authenticity, transparency, and responsible practices.
              </p>
              <div className="">
